							...
							<div
								...
								<div>
									<div
										...
										<h3
											class="mb-0 text-lg font-semibold text-gray-900 leading-8">
											<?php the_sub_field('title'); ?>
										</h3>
										<?php if ($i === 2): ?>
											<p
												class="rounded-full bg-blue-light py-1 px-2.5 text-xs font-semibold leading-5 text-white">
												Populair</p>
										<?php endif; ?>
									</div>
									...
									<p class="flex items-baseline mt-6 gap-x-1">
										<span
											class="text-4xl font-bold tracking-tight text-gray-900">&euro;
											<?php the_sub_field('price'); ?>
										</span>
										<span
											class="text-sm font-semibold text-gray-600 leading-6">/maand</span>
									</p>
									<ul role="list"
										class="mt-8 text-sm text-gray-600 space-y-3 leading-6">
										<?php if (have_rows('usps')): ?>
											<?php while (have_rows('usps')):
												the_row(); ?>
												<li class="flex gap-x-3">
													<svg class="flex-none w-5 h-6 text-blue"
