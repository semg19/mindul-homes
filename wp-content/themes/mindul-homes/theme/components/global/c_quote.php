			...
			<div
				...
				<div class="w-full max-w-2xl -mt-8 xl:-mb-8 xl:w-96 xl:flex-none">
					<div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
						...
						<?php if ($image): ?>
							<img class="absolute inset-0 object-cover w-full h-full bg-gray-800 shadow-2xl rounded-2xl"
					...
					<?php while (have_rows('content')):
						...
						<div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
							<figure class="relative pt-6 isolate sm:pt-12">
								...
								<blockquote class="text-xl font-semibold text-white leading-8 sm:text-2xl sm:leading-9">
									<p>
