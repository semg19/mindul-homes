	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( ( $this->enableCopyValuesOption || $is_form_editor ) && ! $is_entry_detail ) {
			...
			$copy_values_option     = "<div id='{$field_id}_copy_values_option_container' class='copy_values_option_container' {$copy_values_style}>
                                        ...
                                        <label for='{$field_id}_copy_values_activated' id='{$field_id}_copy_values_option_label' class='inline copy_values_option_label gform-field-label gform-field-label--type-inline'>{$copy_values_label}</label>
                                    </div>";
