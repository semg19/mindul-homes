...
<ul>
	...
	<div id="front-page-warning" class="inline notice notice-warning"><p><?php _e( '<strong>Warning:</strong> these pages should not be the same!' ); ?></p></div>
	<?php endif; ?>
	...
	<div id="privacy-policy-page-warning" class="inline notice notice-warning"><p><?php _e( '<strong>Warning:</strong> these pages should not be the same as your Privacy Policy page!' ); ?></p></div>
	<?php endif; ?>
</fieldset></td>
</tr>
<?php endif; ?>
